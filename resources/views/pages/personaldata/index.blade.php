...
<nav class="navbar navbar-inverse">
    <div class="navbar-header">
        <a class="navbar-brand" href="{{ URL::to('personal_details') }}">Nerd Alert</a>
    </div>
    <ul class="nav navbar-nav">
        <li><a href="{{ URL::to('personal_details') }}">View All Nerds</a></li>
        <li><a href="{{ URL::to('personal_details/create') }}">Create a Nerd</a>
    </ul>
</nav>
    ...
    @foreach($personal_details as $key => $value)
        <tr>
            ...
            <td>
                ...
                <a class="btn btn-small btn-success" href="{{ URL::to('personal_details/' . $value->id) }}">Show this Nerd</a>

                <!-- edit this nerd (uses the edit method found at GET /nerds/{id}/edit -->
                <a class="btn btn-small btn-info" href="{{ URL::to('personal_details/' . $value->id . '/edit') }}">Edit this Nerd</a>
