...
<div class="range range-xs-center">
  <div class="practical-introduction" >
    <div class="row" style="margin-bottom:30px;">
      ...
      <div class="col-md-4">
        <div class="flex-mid-container direction--column  max-width--1024">
          <ul class="blog-roll__flex-container" style="display:block;">
...
<div class="range range-xs-center offset-top-66">
  <div class="cell-xs-7 cell-sm-5 cell-md-4 cell-lg-3">
    <div class="inset-lg-left-20 inset-lg-right-20"><a href="/posts" class="btn btn-primary reveal-xs-block">view all blog posts</a></div>
  </div>
</div>
</div>
</section>
