    ...
    <div class="container">
      <div class="breadcrumb-menu flex items-center no-column">
        ...
        <div class="breadcrumb-info-dashboard">
          <h2>TYDInnovationIncubator</h2>
          <h4>ilala, Dar es salaam</h4>
              ...
              <div id="favorite-candidates" class="tab-pane fade in active">
                  ...
                  <div class="favorite-candidates-list-wrapper">
                    ...
                    <div class="candidate-name-cell candidate-cell flex items-center no-column no-wrap">
                      ...
                      <div class="candidate-cell-inner flex items-center no-column no-wrap">
                        <div class="candidate-img">
                          <img src="image/candidate-small01.jpg" alt="candidate-image" class="img-responsive">
                    ...
                    <div class="candidate-name-cell candidate-cell flex items-center no-column no-wrap">
                      ...
                      <div class="candidate-cell-inner flex items-center no-column no-wrap">
                        <div class="candidate-img">
                          <img src="image/candidate-small02.jpg" alt="candidate-image" class="img-responsive">
                        </div> <!-- end .candidate-img -->
                        <div class="cell-text no-column">
                          <h4>David Ortega</h4>
                    ...
                    <div class="candidate-name-cell candidate-cell flex items-center no-column no-wrap">
                      ...
                      <div class="candidate-cell-inner flex items-center no-column no-wrap">
                        <div class="candidate-img">
                          <img src="image/candidate-small03.jpg" alt="candidate-image" class="img-responsive">
                        </div> <!-- end .candidate-img -->
                        <div class="cell-text no-column">
                          <h4>Tammy Dixon</h4>
                          <p>Copywriter</p>
                    ...
                    <div class="candidate-name-cell candidate-cell flex items-center no-column no-wrap">
                      ...
                      <div class="candidate-cell-inner flex items-center no-column no-wrap">
                        <div class="candidate-img">
                          <img src="image/candidate-small04.jpg" alt="candidate-image" class="img-responsive">
                        </div> <!-- end .candidate-img -->
                        <div class="cell-text no-column">
                    ...
                    <div class="candidate-name-cell candidate-cell flex items-center no-column no-wrap">
                      ...
                      <div class="candidate-cell-inner flex items-center no-column no-wrap">
                        <div class="candidate-img">
                          <img src="image/candidate-small05.jpg" alt="candidate-image" class="img-responsive">
                        </div> <!-- end .candidate-img -->
                        <div class="cell-text no-column">
              ...
              <div id="manage-applications-employer" class="tab-pane fade in">
                  ...
                  <div class="candidate-applications-list-wrapper">
                    ...
                    <div class="candidate-name-cell candidate-cell flex items-center no-column no-wrap">
                      ...
                      <div class="candidate-cell-inner flex items-center no-column no-wrap">
                        <div class="candidate-img">
                          <img src="image/candidate-small06.jpg" alt="candidate-image" class="img-responsive">
                        </div> <!-- end .candidate-img -->
                        <div class="cell-text no-column">
                    ...
                    <div class="candidate-name-cell candidate-cell flex items-center no-column no-wrap">
                      ...
                      <div class="candidate-cell-inner flex items-center no-column no-wrap">
                        <div class="candidate-img">
                          <img src="image/candidate-small07.jpg" alt="candidate-image" class="img-responsive">
                        </div> <!-- end .candidate-img -->
                        <div class="cell-text no-column">
                    ...
                    <div class="candidate-name-cell candidate-cell flex items-center no-column no-wrap">
                      ...
                      <div class="candidate-cell-inner flex items-center no-column no-wrap">
                        <div class="candidate-img">
                          <img src="image/candidate-small08.jpg" alt="candidate-image" class="img-responsive">
                        </div> <!-- end .candidate-img -->
                        <div class="cell-text no-column">
              ...
              <div id="profile" class="tab-pane fade in">
                ...
                <div class="profile-info profile-section flex no-column no-wrap">
                  <div class="profile-picture">
                    <img src="image/company-logo-jumbo01.jpg" alt="company-logo" class="img-responsive">
