    ...
    <div class="col-md-12">
      <div class="box box-primary">
          <div class="box-header with-border">
            <h3 class="box-title">CREATE PRASDEL</h3>
...
@endif
      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="title" name="title" placeholder="Enter PostTitle">
        </div>
        <div class="form-group">
       ...
       <div class="form-group">
            ...
            <div class="box">
              ...
              <div class="box-body pad">
                  ...
                  <textarea style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" name="body"  id="editor1"></textarea>
